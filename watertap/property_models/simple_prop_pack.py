...
#################################################################################
"""
Simple property package for H2O-NaCl system (most common assumptions)
"""
...
class NaClParameterData(PhysicalParameterBlock):
    ...
    def build(self):
        ...
        dens_mass_param_dict = 1000  # density of water
...
class NaClStateBlockData(StateBlockData):
    ...
    def _dens_mass_phase(self):
        ...
        def rule_dens_mass_phase(b, p):
            return b.dens_mass_phase[p] == b.params.dens_mass_param
    ...
    def _visc_d_phase(self):
        ...
        def rule_visc_d_phase(b, p):
            x = 0.035  # assume seawater water mass frac
            return (
                b.visc_d_phase[p]
                == b.params.visc_d_param["1"] * x + b.params.visc_d_param["0"]
            )
    ...
    def _diffus_phase_comp(self):
        ...
        def rule_diffus_phase_comp(b, p, j):
            ...
            return b.diffus_phase_comp[p, j] == (
                b.params.diffus_param["4"] * x**4
                + b.params.diffus_param["3"] * x**3
                + b.params.diffus_param["2"] * x**2
                + b.params.diffus_param["1"] * x
    ...
    def _enth_mass_phase(self):
        ...
        def rule_enth_mass_phase(b, p):
            # specific enthalpy, H' = Cp(T-Tref) + (P-Pref)/rho
    ...
    def _pressure_sat(self):
        ...
        def rule_pressure_sat(b):
            # Roult's Law
            x = b.mass_frac_phase_comp["Liq", "H2O"]
    ...
    def _therm_cond_phase(self):
        ...
        # Estimated for seawater at 25 C
        def rule_therm_cond_phase(b, p):
            t = 25  # C
            x = 0.035  # mass frac NaCl
            param_vec = [
