...
import watertap.examples.flowsheets.boron_removal.boron_removal_1_stage_props as boron_removal_flowsheet
...
def set_up_sensitivity():
    ...
    outputs["Recovery"] = m.fs.RO1.recovery_mass_phase_comp[0, "Liq", "H2O"]
...
def run_analysis(case_num=1, nx=2, interpolate_nan_outputs=True, output_filename=None):
    ...
    if output_filename is None:
        output_filename = "sensitivity_full_flowsheet_membrane_properties_" + str(case_num) + ".csv"
