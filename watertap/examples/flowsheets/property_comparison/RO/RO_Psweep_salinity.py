...
#     m.fs.RO.recovery_mass_phase_comp[0, "Liq", "H2O"], 0.3, 0.7, 21
# )
# sweep_params["Inlet Salinity"] = LinearSample(
#     m.fs.feed.properties[0].mass_frac_phase_comp["Liq", "NaCl"], 0.01, 0.05, 41
# )
...
# )
# sweep_params["Inlet Salinity"] = LinearSample(
#     m.fs.feed.properties[0].mass_frac_phase_comp["Liq", "TDS"], 0.01, 0.05, 41
# )
